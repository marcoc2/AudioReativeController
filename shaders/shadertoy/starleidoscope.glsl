// title: starleidoscope (nome do arquivo; confirmar o título no Shadertoy)
// url: (preencher)
// author: (preencher)
// license: CC BY-NC-SA 3.0 (padrão do Shadertoy; confirmar)
// iChannel0: sound
// notes: campo de estrelas em 10 camadas de profundidade, dobrado por espelhos (abs + reflexões em 150° e 120°, 5 vezes com zoom 1.25) num caleidoscópio; o espectro da música (iChannel0 = som, faixa em x = 0.25, ~2,7 kHz) desloca a cor de todas as estrelas
