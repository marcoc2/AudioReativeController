// title: prism liquid — Buffer A (cena)
// url: (preencher)
// author: (preencher)
// license: CC BY-NC-SA 3.0 (padrão do Shadertoy; confirmar)
// notes: vidro líquido por raymarching com refração: prisma octaédrico em gomos (1..31, variando com o tempo) + massa líquida (esfera fundida com 18 cápsulas e 18 bolhas em órbita); reflexo de céu, grão e manchas de filme
